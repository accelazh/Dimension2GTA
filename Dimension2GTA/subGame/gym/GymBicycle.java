 ...
 * 
 */
public class GymBicycle extends GymSuper
{
	//for debug
	private static final boolean debug=true;

	public GymBicycle(Player player,Human opponent,MainGameWindow master)
	{
	...
	public void initializeImageSequence() 
	{
		...
		while(picFile.exists())
		{
			...
			num++;
	        picFile=new File("pic/SubGame/gym/bicycle/"+num+".gif");
		}
