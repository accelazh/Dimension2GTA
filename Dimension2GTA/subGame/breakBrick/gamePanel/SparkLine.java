...
public class SparkLine implements Constants
{
	private static final boolean debug2=false;
	private static final boolean debug3=false;
	
	private static final int sparkLineLength=25;
	...
	public SparkLine(Point3D headPoint, Vector3D v,int order)
	{
	...
	public void selfProcess()
	{
		...
		if(debug2&&order==2)
		{
	        ...
	        if(headPoint.z<-wallPanelSize.height-sparkLineLength)
	        {
	        	useAble=false;
	        }
