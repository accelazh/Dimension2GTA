...
public class WallPanel extends JPanel implements MouseListener,
	...
	public static final int TIMER_INTERVAL = ShootingPractice7.TIMER_INTERVAL;

	private ShootingPractice7 shootingPractice7 = null;
	private WallPanel wallPanel = this;

	public static final Dimension brickSize = new Dimension(40, 13);
	public static final Dimension wallPanelTotalSize = ShootingPractice7.mainPanelSize;
	...
	//bricks
	public static ImageIcon[] brickImageIconsR = {
			new ImageIcon("pic/SubGame/shootingPractice/brick/r" + 0 + ".gif"),
			new ImageIcon("pic/SubGame/shootingPractice/brick/r" + 1 + ".gif"),
			new ImageIcon("pic/SubGame/shootingPractice/brick/r" + 2 + ".gif"),
			new ImageIcon("pic/SubGame/shootingPractice/brick/r" + 3 + ".gif"),
			new ImageIcon("pic/SubGame/shootingPractice/brick/r" + 4 + ".gif"),
			new ImageIcon("pic/SubGame/shootingPractice/brick/r" + 5 + ".gif"),
			new ImageIcon("pic/SubGame/shootingPractice/brick/r" + 6 + ".gif"),
			new ImageIcon("pic/SubGame/shootingPractice/brick/r" + 7 + ".gif"), };

	public static ImageIcon[] brickImageIconsO = {
			new ImageIcon("pic/SubGame/shootingPractice/brick/o" + 0 + ".gif"),
			new ImageIcon("pic/SubGame/shootingPractice/brick/o" + 1 + ".gif"),
			new ImageIcon("pic/SubGame/shootingPractice/brick/o" + 2 + ".gif"),
			new ImageIcon("pic/SubGame/shootingPractice/brick/o" + 3 + ".gif"),
			new ImageIcon("pic/SubGame/shootingPractice/brick/o" + 4 + ".gif"),
			new ImageIcon("pic/SubGame/shootingPractice/brick/o" + 5 + ".gif"),
			new ImageIcon("pic/SubGame/shootingPractice/brick/o" + 6 + ".gif"),
			new ImageIcon("pic/SubGame/shootingPractice/brick/o" + 7 + ".gif"), };

	public static ImageIcon[] brickImageIconsY = {
			new ImageIcon("pic/SubGame/shootingPractice/brick/y" + 0 + ".gif"),
			new ImageIcon("pic/SubGame/shootingPractice/brick/y" + 1 + ".gif"),
			new ImageIcon("pic/SubGame/shootingPractice/brick/y" + 2 + ".gif"),
			new ImageIcon("pic/SubGame/shootingPractice/brick/y" + 3 + ".gif"),
			new ImageIcon("pic/SubGame/shootingPractice/brick/y" + 4 + ".gif"),
			new ImageIcon("pic/SubGame/shootingPractice/brick/y" + 5 + ".gif"),
			new ImageIcon("pic/SubGame/shootingPractice/brick/y" + 6 + ".gif"),
			new ImageIcon("pic/SubGame/shootingPractice/brick/y" + 7 + ".gif"), };

	public static ImageIcon[] brickImageIconsG = {
			new ImageIcon("pic/SubGame/shootingPractice/brick/g" + 0 + ".gif"),
			new ImageIcon("pic/SubGame/shootingPractice/brick/g" + 1 + ".gif"),
			new ImageIcon("pic/SubGame/shootingPractice/brick/g" + 2 + ".gif"),
			new ImageIcon("pic/SubGame/shootingPractice/brick/g" + 3 + ".gif"),
			new ImageIcon("pic/SubGame/shootingPractice/brick/g" + 4 + ".gif"),
			new ImageIcon("pic/SubGame/shootingPractice/brick/g" + 5 + ".gif"),
			new ImageIcon("pic/SubGame/shootingPractice/brick/g" + 6 + ".gif"),
			new ImageIcon("pic/SubGame/shootingPractice/brick/g" + 7 + ".gif"), };

	public static ImageIcon[] brickImageIconsQ = {
			new ImageIcon("pic/SubGame/shootingPractice/brick/q" + 0 + ".gif"),
			new ImageIcon("pic/SubGame/shootingPractice/brick/q" + 1 + ".gif"),
			new ImageIcon("pic/SubGame/shootingPractice/brick/q" + 2 + ".gif"),
			new ImageIcon("pic/SubGame/shootingPractice/brick/q" + 3 + ".gif"),
			new ImageIcon("pic/SubGame/shootingPractice/brick/q" + 4 + ".gif"),
			new ImageIcon("pic/SubGame/shootingPractice/brick/q" + 5 + ".gif"),
			new ImageIcon("pic/SubGame/shootingPractice/brick/q" + 6 + ".gif"),
			new ImageIcon("pic/SubGame/shootingPractice/brick/q" + 7 + ".gif"), };

	public static ImageIcon[] brickImageIconsB = {
			new ImageIcon("pic/SubGame/shootingPractice/brick/b" + 0 + ".gif"),
			new ImageIcon("pic/SubGame/shootingPractice/brick/b" + 1 + ".gif"),
			new ImageIcon("pic/SubGame/shootingPractice/brick/b" + 2 + ".gif"),
			new ImageIcon("pic/SubGame/shootingPractice/brick/b" + 3 + ".gif"),
			new ImageIcon("pic/SubGame/shootingPractice/brick/b" + 4 + ".gif"),
			new ImageIcon("pic/SubGame/shootingPractice/brick/b" + 5 + ".gif"),
			new ImageIcon("pic/SubGame/shootingPractice/brick/b" + 6 + ".gif"),
			new ImageIcon("pic/SubGame/shootingPractice/brick/b" + 7 + ".gif"), };

	public static ImageIcon[] brickImageIconsD = {
			new ImageIcon("pic/SubGame/shootingPractice/brick/d" + 0 + ".gif"),
			new ImageIcon("pic/SubGame/shootingPractice/brick/d" + 1 + ".gif"),
			new ImageIcon("pic/SubGame/shootingPractice/brick/d" + 2 + ".gif"),
			new ImageIcon("pic/SubGame/shootingPractice/brick/d" + 3 + ".gif"),
			new ImageIcon("pic/SubGame/shootingPractice/brick/d" + 4 + ".gif"),
			new ImageIcon("pic/SubGame/shootingPractice/brick/d" + 5 + ".gif"),
			new ImageIcon("pic/SubGame/shootingPractice/brick/d" + 6 + ".gif"),
			new ImageIcon("pic/SubGame/shootingPractice/brick/d" + 7 + ".gif"), };

	public static ImageIcon[] brickImageIconsP = {
			new ImageIcon("pic/SubGame/shootingPractice/brick/p" + 0 + ".gif"),
			new ImageIcon("pic/SubGame/shootingPractice/brick/p" + 1 + ".gif"),
			new ImageIcon("pic/SubGame/shootingPractice/brick/p" + 2 + ".gif"),
			new ImageIcon("pic/SubGame/shootingPractice/brick/p" + 3 + ".gif"),
			new ImageIcon("pic/SubGame/shootingPractice/brick/p" + 4 + ".gif"),
			new ImageIcon("pic/SubGame/shootingPractice/brick/p" + 5 + ".gif"),
			new ImageIcon("pic/SubGame/shootingPractice/brick/p" + 6 + ".gif"),
			new ImageIcon("pic/SubGame/shootingPractice/brick/p" + 7 + ".gif"), };

	public static ImageIcon[] brickImageIconsH = {
			new ImageIcon("pic/SubGame/shootingPractice/brick/h" + 0 + ".gif"),
			new ImageIcon("pic/SubGame/shootingPractice/brick/h" + 1 + ".gif"),
			new ImageIcon("pic/SubGame/shootingPractice/brick/h" + 2 + ".gif"),
			new ImageIcon("pic/SubGame/shootingPractice/brick/h" + 3 + ".gif"),
			new ImageIcon("pic/SubGame/shootingPractice/brick/h" + 4 + ".gif"),
			new ImageIcon("pic/SubGame/shootingPractice/brick/h" + 5 + ".gif"),
			new ImageIcon("pic/SubGame/shootingPractice/brick/h" + 6 + ".gif"),
			new ImageIcon("pic/SubGame/shootingPractice/brick/h" + 7 + ".gif"), };

	public static ImageIcon[] brickImageIconsW = {
			new ImageIcon("pic/SubGame/shootingPractice/brick/w" + 0 + ".gif"),
			new ImageIcon("pic/SubGame/shootingPractice/brick/w" + 1 + ".gif"),
			new ImageIcon("pic/SubGame/shootingPractice/brick/w" + 2 + ".gif"),
			new ImageIcon("pic/SubGame/shootingPractice/brick/w" + 3 + ".gif"),
			new ImageIcon("pic/SubGame/shootingPractice/brick/w" + 4 + ".gif"),
			new ImageIcon("pic/SubGame/shootingPractice/brick/w" + 5 + ".gif"),
			new ImageIcon("pic/SubGame/shootingPractice/brick/w" + 6 + ".gif"),
			new ImageIcon("pic/SubGame/shootingPractice/brick/w" + 7 + ".gif"), };

	public final static Image[] brickImagesR = new Image[brickImageIconsR.length];
	public final static Image[] brickImagesO = new Image[brickImageIconsR.length];
	public final static Image[] brickImagesY = new Image[brickImageIconsR.length];
	public final static Image[] brickImagesG = new Image[brickImageIconsR.length];
	public final static Image[] brickImagesQ = new Image[brickImageIconsR.length];
	public final static Image[] brickImagesB = new Image[brickImageIconsR.length];
	public final static Image[] brickImagesD = new Image[brickImageIconsR.length];
	public final static Image[] brickImagesP = new Image[brickImageIconsR.length];
	public final static Image[] brickImagesH = new Image[brickImageIconsR.length];
	public final static Image[] brickImagesW = new Image[brickImageIconsR.length];
	...
	public final static Image[][] brickImages = {
			...
			new Image[] { Toolkit.getDefaultToolkit().getImage(
					"pic/SubGame/shootingPractice/brick/firm.gif"), } };

	static {
		for (int i = 0; i < brickImageIconsR.length; i++) {

			brickImagesR[i] = brickImageIconsR[i].getImage();
			brickImagesO[i] = brickImageIconsO[i].getImage();
			brickImagesY[i] = brickImageIconsY[i].getImage();
			brickImagesG[i] = brickImageIconsG[i].getImage();
			brickImagesQ[i] = brickImageIconsQ[i].getImage();
			brickImagesB[i] = brickImageIconsB[i].getImage();
			brickImagesD[i] = brickImageIconsD[i].getImage();
			brickImagesP[i] = brickImageIconsP[i].getImage();
			brickImagesH[i] = brickImageIconsH[i].getImage();
			brickImagesW[i] = brickImageIconsW[i].getImage();
		}

		brickImageIconsR = null;
		brickImageIconsO = null;
		brickImageIconsY = null;
		brickImageIconsG = null;
		brickImageIconsQ = null;
		brickImageIconsB = null;
		brickImageIconsD = null;
		brickImageIconsP = null;
		brickImageIconsH = null;
		brickImageIconsW = null;
	...
	//对靶子的运动周期的控制
	public final static double gravity = ShootingPractice6.gravity; //单位象素每秒的平方

	private ImageIcon background = new ImageIcon(
			"pic/SubGame/shootingPractice/bk5.jpg");
	...
	public WallPanel(ShootingPractice7 shootingPractice7) {
		this.shootingPractice7 = shootingPractice7;
	...
	public void initializeBricks() 
	{
		...
		File mapFile=new File("Dimension2GTA/subGame/breakBrick/maps/"+random+".brickTypes");
	
        initializeBricks(mapFile);	
	}
	...
	public void selfProcess() {
		...
		if (shootingPractice7.STARTED == shootingPractice7.getGameState()) {
			//处理开枪
			if (attacking) {
				if (gun.shoot()) {
					shootingPractice7.hitAndScore();
					gunAim.shootAdjust();
					switch (currentGun) {
					case DEAGLE: {
						playDeagleClip();
					...
					if (currentGun != ROCKET) {
						if (distance < ballRadius) {
							...
							if (currentGun != M4) {
								addSpark2(new Spark2(new MyPoint(mousePoint.x,
										mousePoint.y), this));
							} else {
								addSpark2(new Spark2(new MyPoint(mousePoint.x,
										mousePoint.y), this, false));
							}
	...
	protected void paintComponent(Graphics g) {
		...
		g.drawString("Score: " + socre, scoreLocation.x,
			...
			if (gun.shoot()) {
				...
				if (currentGun != ROCKET) {
					...
					if (distance < ballRadius) {
						...
						if (currentGun != M4) {
							addSpark2(new Spark2(new MyPoint(e.getPoint().x, e
									.getPoint().y), this));
						} else {
							addSpark2(new Spark2(new MyPoint(e.getPoint().x, e
									.getPoint().y), this, false));
						}
