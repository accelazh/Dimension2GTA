...
public class Firework 
{
	...
	private long BoomingDisplayTimeCount=300;  //描述爆炸后多少个timerInterval后消失
	
	private SubSpark boom;
	private Sparks sparkBoomed;
	private double startVelocity=1300;	
	
	private double boomVelocity=1300;
	private int sparkLineNumPerLayer=40;
	private int sparkLineLayerNum=6;
