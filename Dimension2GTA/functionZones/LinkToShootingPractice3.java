...
public class LinkToShootingPractice3 extends FunctionZone
{
	
	
	

	public LinkToShootingPractice3(MyPoint location,Dimension totalSize)
	{
	...
	public void functionPerformed(Human whoTriggers, MainGameWindow master)
	{
		if(whoTriggers instanceof Player)
		{
			...
			ShootingPractice3 shootingPractice3=new ShootingPractice3(player,null,master);
		}
